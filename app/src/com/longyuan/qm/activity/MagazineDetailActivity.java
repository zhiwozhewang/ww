...
//            + "UserMagazineFavoriteAdd.ashx?";
    ...
    private Button leftBtn, attention_btn, rightBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.magazinedetail_fragment_normal);
...
//                    null);
        ...
        mContext = MagazineDetailActivity.this;
        headTitle = (TextView) findViewById(R.id.head_layout_text);
        mag_name = (TextView) findViewById(R.id.mag_name);
        title_classify = (TextView) findViewById(R.id.title_classify);
        title_qk = (TextView) findViewById(R.id.title_qk);
        mag_detail = (TextView) findViewById(R.id.mag_detail);
        attention_btn = (Button) findViewById(R.id.attention_btn);
        leftBtn = (Button) findViewById(R.id.head_layout_showLeft);
        rightBtn = (Button) findViewById(R.id.head_layout_showRight);
        rightBtn.setVisibility(View.GONE);

        mGridView = (PullToRefreshGridView) findViewById(R.id.mag_detail_gridview);
            ...
            public void onClick(View v) {
                if (isInternet()) {
                    if (magazineAttentionBean != null) {
                        ...
                        Toast.makeText(mContext, "数据加载失败!",
...
//        String path = ADDMAGFAVORITE_URL + "apptoken=" + ConstantsAmount.APPTOKEN + "&ticket=" + ConstantsAmount.TICKET + "&resourceid=" + mag_guid + "&resourcekind=2";
        ...
        httpUtils.send(HttpRequest.HttpMethod.POST, ADDMAGFAVORITE_URL, params, new RequestCallBack<String>() {
...
//        LoadingDialog.showDialog(mContext, "正在加载...");
        magazineAttentionBean = new MagazineAttentionBean();
        HttpUtils httpUtils = new HttpUtils();
        httpUtils.send(HttpRequest.HttpMethod.GET, path,
                new RequestCallBack<String>() {
