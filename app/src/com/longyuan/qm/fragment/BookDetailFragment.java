...
public class BookDetailFragment extends BaseFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater
                .inflate(R.layout.bookdetail_activity_normal, null);
        mContext = getActivity();
        userName = mSp.getString("username", null);

        bookName = (TextView) mView.findViewById(R.id.bkname);
        author = (TextView) mView.findViewById(R.id.textView_auth);
        bookType = (TextView) mView.findViewById(R.id.textView_sub);
        bookPress = (TextView) mView.findViewById(R.id.textView_pub);
        bookNote = (TextView) mView.findViewById(R.id.TextView_detail);
        headTitle = (TextView) mView.findViewById(R.id.head_layout_text);
        imageView = (ImageView) mView.findViewById(R.id.book_cover);
        leftBtn = (Button) mView.findViewById(R.id.head_layout_showLeft);
        addBtn = (Button) mView.findViewById(R.id.addBookShelf);
        ...
        leftBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bookShopFragment = new BookShopFragment();
                beginTransaction.replace(R.id.fl_main, bookShopFragment);
    ...
    /**
     * (非 Javadoc) Title: onResume Description:
     *
    ...
    public void onResume() {
        super.onResume();
        // 判断所选的图书是否已存在
        List<BookClassifyBean> bookInfo = DataBase.getInstance(getActivity())
    ...
    /*private void setContent() {
        bookName.setText(bookClassifyBean.getBookName());
        author.setText(bookClassifyBean.getAuthor());
        bookType.setText(bookClassifyBean.getCategory());
        bookPress.setText(bookClassifyBean.getPublishName());
//                    + "/"
//                    + bookClassifyBean.getPubDate());
           *//* bookNote.setText("    "
                    + Utils.replaceHtmlTag(bookClassifyBean.getNote()));*//*
        BitmapUtils bitmapUtil = new BitmapUtils(mContext);
        bitmapUtil
                .configDefaultLoadingImage(R.drawable.empty_photo_vertical);
        bitmapUtil
                .configDefaultLoadFailedImage(R.drawable.empty_photo_vertical);
        bitmapUtil.display(imageView, bookClassifyBean.getBookCover());
        headTitle.setText("简介");
    }*/
    ...
    public void onClick(View v) {
        ...
        if (!mFlag) {
            if (isInternet()) {
                ...
                DataBase.getInstance(getActivity()).addToBookShelfList(
                        bookClassifyBean);
