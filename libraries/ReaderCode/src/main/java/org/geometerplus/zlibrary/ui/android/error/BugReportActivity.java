...
public class BugReportActivity extends Activity implements ErrorKeys {
	public void onCreate(Bundle icicle) {
		...
		reportTextView.append("LReader " + versionName + " has been crached, sorry. You can help to fix this bug by sending the report below to LReader developers. The report will be sent by e-mail. Thank you in advance!\n\n");
		...
		findViewById(R.id.send_report).setOnClickListener(
			new View.OnClickListener() {
				public void onClick(View view) {
					...
					sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "smartydroid@gmail.com" });
					sendIntent.putExtra(Intent.EXTRA_TEXT, reportText.toString());
					sendIntent.putExtra(Intent.EXTRA_SUBJECT, "LReader " + versionName + " exception report");
